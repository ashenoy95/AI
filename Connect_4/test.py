...
def test_2():
  ...
  perfts = [117649, 117648, 117431, 117430, 117213, 115461, 112707, 91787, 78679, 87247, 78383, 85599, 74934, 81279, 66097, 73244, 86238, 73351, 74531, 56724, 56152, 21664, 18546, 13302, 13459, 9263, 4670, 4548]
  b = board.Board()
